  ...
  computed:{
    ...
    getRoutinesFilter(){
      ...
      if(this.filterSearch === 'Nombre de la rutina')
        routines = this.getFavouriteRoutines.filter(routine => routine.name.startsWith(this.textSearch))
      else
        routines = this.getFavouriteRoutines.filter(routine => routine.user.username.startsWith(this.textSearch))
